...
//  public static Photonvision frontCamera = new Photonvision(Constants.PhotonVision.frontCameraName, new Transform3d(new Translation3d(0, 0.0, 0.5), new Rotation3d(0,0,Math.PI)));
  public static Photonvision backCamera = new Photonvision(Constants.PhotonVision.backCameraName, new Transform3d(new Translation3d(0, 0.0, 0.5), new Rotation3d(0,0,Math.PI)));
...
//
  ...
  private void configureBindings()
  {
    ...
    new Trigger(driverController::getCircleButton).onTrue(AutoFactory.pathFindThenFollowPath("Subwoofer"));
